...
export default function CurrentExerciseInfo({
  ...
  return (
    <div className="w-full max-w-2xl text-center mb-10 px-4">
      <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-800 px-5 py-1.5 rounded-full text-sm font-medium mb-4 shadow-sm">
        <span className="w-2.5 h-2.5 rounded-full bg-orange-500 animate-pulse"></span>
        Current Exercise
      </div>

      <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-800 leading-tight mb-4">
